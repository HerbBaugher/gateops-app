            ...
            with st.expander("📄 PREVIEW PROFESSIONAL COMPLIANCE LOG HANDOUT"):
                ...
                <div class="report-box">
                    <div style='display:flex; justify-content:space-between; align-items:center;'>
                        ...
                        <span style='background-color:#4CD964; color:white; padding:5px 10px; border-radius:4px; font-weight:bold;'>SAFETY CERTIFIED</span>
                    </div>
                    <hr>
                    ...
                    <hr>
                    <h4 style='text-align:right; color:#555;'>Statement Invoice Total Paid: ${r_data['total_with_fees']:.2f}</h4>
                </div>
                """
